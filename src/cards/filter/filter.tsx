...
export const Filter = () => {
  const {
    ...
    handleChangeType,
    handleSelectCountry,
  } = useContext(StateContext) as MyContextValues;
  ...
  return (
    <div className="w-[325px] flex flex-col gap-[25px]">
      ...
      />
      <HouseType type={type} handleChangeType={handleChangeType} />
      <RatingStar stars={stars} handleChangeStars={handleChangeStars} />
      <ReviewCount
